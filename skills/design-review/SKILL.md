...
**เมื่อสรุป "ต้องแก้อะไรบ้าง" ให้จัดกลุ่มตามหมวดหมู่เสมอ** (เช่น Copy, Interaction/Loading state, Edge case, DS Integration) ไม่ใช่โยนเป็น list เดียวรวมกัน — ใส่หัวข้อกลุ่มสั้นๆ นำหน้าแต่ละกลุ่ม เพื่อให้ designer scan ได้เร็วว่าอันไหนเกี่ยวกับอะไร
